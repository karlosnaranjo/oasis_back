...
// Repositories
use App\Http\Repositories\PsychologyDrugsRespository;

// Resources
use App\Http\Resources\V1\PsychologyDrugsResource;



class PsychologyDrugsController extends ApiController
{
    use IndexTrait;
    ...
    {
        $repo = new PsychologyDrugsRespository();
        return $repo->getPsychologyDrugsList($request);
    }
    ...
    public function store(Request $request)
    {
        ...
        $result = PsychologyDrugs::create($dataIn);

        // send a successful response
        return $this->successResponse(
            $code = Response::HTTP_CREATED,
            $data = new PsychologyDrugsResource($result),
     ...
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Models\{PsychologyDrugs}  $PsychologyDrugs
     * @return \Illuminate\Http\Response
     */
    public function update($id, Request $request)
    {
        // Find the id into the database using its model
        $result = PsychologyDrugs::find($id);
    ...
    public function updateOrCreate($id, Request $request)
    {
        ...
        $result = PsychologyDrugs::where('psychology_id', $parentId)->first(); 
     ...
     *
     * @param  \App\Models\{PsychologyDrugs}  $seg_PsychologyDrugs
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Models\{PsychologyDrugs} 
     * @return \Illuminate\Http\Response
     */
    ...
    public function initForm(Request $request)
    {
        ...
        $id = $request->get('id');
        $data =  ((isset($id) and !is_null($id)) ? PsychologyDrugs::where('id', '=', $id)->first()
            : new PsychologyDrugs());
        ...
        $respuesta = [
			"psychologyDrugs" => new PsychologyDrugsResource($data),
			"drug" => $drug,
        ];
